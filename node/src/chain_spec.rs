...
pub fn crg_staging_network_config() -> ChainSpec {
	let boot_nodes = vec![];

	ChainSpec::from_genesis(
		"crg",
		"crg_staging_network_config",
		ChainType::Live,
		crg_staging_network_config_genesis,
		boot_nodes,
		Some(
...
fn crg_staging_network_config_genesis() -> GenesisConfig {
